...
//                notify=true;
                setNotiFirebase();
                Intent Writeinfor=new Intent(ScheduleSelectActivity.this, RequestSuccessActivity.class);
...
//                                provideID=noti.getProvider_id();
                                ...
                                dtb_Noti.collection("Notification")
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                            ...
                                            public void onSuccess(DocumentReference documentReference) {
                                                ...
                                                Intent intent = new Intent(ScheduleSelectActivity.this, RequestSuccessActivity.class);
                            ...
                            Toast.makeText(ScheduleSelectActivity.this, "Không thể lấy thông báo", Toast.LENGTH_SHORT).show();
                        }
                        ...
                        dtb_update.collection("Notification").document(NotiID)
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(ScheduleSelectActivity.this, "DocumentSnapshot successfully updated!", Toast.LENGTH_LONG).show();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(ScheduleSelectActivity.this, "Error updating document", Toast.LENGTH_LONG).show();
                                    }
                                });
                    }
                });
