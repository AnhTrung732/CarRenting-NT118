...
public class UpdateVehicleAcitivty extends AppCompatActivity {
            ...
            dtb_vehicle.collection("Vehicles")
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(UpdateVehicleAcitivty.this, "Không thể cập nhật thông tin", Toast.LENGTH_LONG).show();
                            return;
                        }
                    })
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            Toast.makeText(UpdateVehicleAcitivty.this, "Câp nhật thông tin thành công", Toast.LENGTH_LONG).show();
                            finish();
                        }
                    });
        }
        ...
        dtb_vehicle.collection("Vehicles")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(UpdateVehicleAcitivty.this, "Xóa xe thành công", Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(UpdateVehicleAcitivty.this, "Không thể xóa xe", Toast.LENGTH_LONG).show();
                    }
                });
    }
}